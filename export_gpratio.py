...
if not os.path.exists('./output/melt/annual_precip_rivers_noglac.nc'):
    dfs = []
    ...
    for bout in bouts: #[0]
        ...
        brivs = pd.read_csv(f'./output/upstream/melt_rivup_noglac_{bout}.csv')
    ...
    ds.to_netcdf('./output/melt/annual_precip_rivers_noglac.nc')

else:
    ds = xr.open_dataset('./output/melt/annual_precip_rivers_noglac.nc')
